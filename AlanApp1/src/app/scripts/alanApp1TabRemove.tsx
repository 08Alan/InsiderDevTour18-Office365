...
export interface IalanApp1TabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IalanApp1TabRemoveProps extends ITeamsBaseComponentProps {

}

/**
 * Implementation of AlanApp1 Tab remove page
 */
export class alanApp1TabRemove  extends TeamsBaseComponent<IalanApp1TabRemoveProps, IalanApp1TabRemoveState> {
